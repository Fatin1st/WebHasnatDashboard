...
const calculatePcColor = (percentage) => {
  const parsedPercentage = parseInt(percentage.replace("%", ""), 10);
  return parsedPercentage < 0 ? "red-600" : "green-600";
};
